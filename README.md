...
- **Media Framework**: Custom playback engine with SoundTouch for pitch/tempo processing
- **Native Library**: SoundTouch 2.3.3 for pitch/tempo
- **Metadata Parsing**: jaudiotagger 3.0.1
- **Icons**: FontAwesome

> **Note**: Minimum SDK is API 21 (Android 5.0) due to native library requirements.
